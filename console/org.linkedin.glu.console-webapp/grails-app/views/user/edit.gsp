                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:userInstance,field:'username','errors')}">
                                  ...
                                  <input type="hidden" id="username" name="username" value="${fieldValue(bean:userInstance,field:'username')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:userInstance,field:'roles','errors')}">
                                  <g:each in="${RoleName.values()}" var="role">
                                    <g:checkBox name="role" value="${role}" checked="${userInstance.hasRole(role)}"/>${role}<br />
                                  </g:each>
                                </td>
                            </tr> 
