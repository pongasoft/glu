...
/**
 * Input stream which counts down
 * 
 * @author yan@pongasoft.com */
public class CountdownInputStream extends FilterInputStream
{
  private final Countdown _countdown

  CountdownInputStream(InputStream inputStream, Countdown countdown)
  {
    super(inputStream)
